...
@section('content')
    <div class="bg-[#f9fbfd] max-h-[100vh] w-fit overflow-hidden flex ">
        @include('asset.adminAside')

        {{-- main --}}
        <main class="w-[calc(100vw-270px)]   relative">
            @include('asset.adminNav')

            <section class="p-6 overflow-y-scroll max-h-[calc(100vh-60px)]">
                <div>
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Reservation</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    ...
                    <admin-reservation></admin-reservation>
