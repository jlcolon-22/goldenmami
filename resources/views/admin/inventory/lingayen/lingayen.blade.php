        ...
        <main class="w-full relative">
            ...
            <section class="p-6 ">
                <div>
                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ml-1 text-sm font-medium text-gray-500 md:ml-2 dark:text-gray-400">Lingayen</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                    ...
                    <inventory-lingayen></inventory-lingayen>
...
@section('scripts')
    <script>
        ...
        document.title = "Inventory Lingayen"
    </script>
@endsection
