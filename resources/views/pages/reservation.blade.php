...
<div class="relative w-screen overflow-hidden ">
    ...
    <section class="flex justify-center flex-col items-center w-full pt-16 pb-10 min-h-[calc(100vh-40px)]   ">
        <div class="w-[95%] sm:w-[85%] mx-auto flex justify-center ">
            <reservation-frontend auth="{{Auth::guard('customer')->check() ? '1' : '0'}}"></reservation-frontend>
        </div>
    </section>
          {{-- footer --}}
